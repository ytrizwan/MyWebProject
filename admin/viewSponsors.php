			...
			<div class="heading">
				...
				<div class="menu">
					<ul>
						...
						<li class="active disabled"><a href="viewSponsors.php"><i class="fas fa-dollar-sign" style="color: white; font-size: 25px; margin-right: 15px;"></i>Insert Sponsors</a></li>
<<<<<<< HEAD
...
>>>>>>> CIT_PressureCooker/master
			...
			<?php
			$judge_query = "SELECT * FROM sponsor
									ORDER BY id DESC";
			...
			?>
				<h2>View Sponsors</h2>
				<h6 style="font-weight: bold">Total Sponsors : <span class="badge"><?php echo $count_rows; ?></span></h6>
				<hr>
				<center><h3><?php echo $get; ?></h3></center>
				<a href="insertSponsor.php" class="btn btn-info" style="float:right">Insert Sponsor</a>
			...
			?>	
						<tr>
							...
							<th>&nbsp;<a href="deleteSponsor.php?id=<?php echo $id_of_judge; ?>" class="btn btn-danger">Delete</a></th>
						</tr>
			<?php
				}
			}
