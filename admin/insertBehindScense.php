	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="container" style="background: #FFF;">
				...
				<form action="insertBehindScense.php" method="post" enctype="multipart/form-data">
					<label for="nameId">Name of BehindScense</label>
					<input required type="text" name="name" id="nameId" class="form-control"><br>
					
					<label for="imgId">Image of BehindScense</label>
					<input required type="file" name="img" id="imgId" class="form-control"><br>
					
					<label for="msgId">About BehindScense</label>
				...
				<?php
					if(isset($_POST['submit'])){
						...
						$msg = $_POST['msg'];
						$insert = "INSERT INTO behindscense(name, img, msg)
									VALUE('$name', '$img', '$msg')";
