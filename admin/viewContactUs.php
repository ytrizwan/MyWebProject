...
<body>
	<div class="row">
			...
			<div class="heading">
				...
				<div class="menu">
					<ul>
						...
						<li class="active disabled"><a href="viewContactUs.php"><i class="fa fa-phone" style="color: white; font-size: 25px; margin-right: 15px;"></i>Contact Us</a></li>
		...
		<div class="col-md-9">
			...
			<?php
			$judge_query = "SELECT * FROM contactus
									ORDER BY id DESC";
			...
			?>
				<h2>Contact Us</h2>
				<h6 style="font-weight: bold">Total Contacts : <span class="badge"><?php echo $count_rows; ?></span></h6>
				<hr>
			...
			if($count_rows > 0){
				while($get_each_row = mysqli_fetch_array($connect_judge_query)){
					...
					$email_of_judge = $get_each_row['email'];
			...
			?>	
						<tr>
							...
							<th><?php echo $email_of_judge; ?></th>
							<th><?php echo $msg_of_judge; ?></th>
							<th><?php echo $date_judge; ?></th>
							<th>&nbsp;<a href="deleteContact.php?id=<?php echo $id_of_judge; ?>" class="btn btn-danger">Delete</a></th>
						</tr>
			<?php
				}
			}
