	...
	<div class="row">
			...
			<div class="heading">
				...
				<div class="menu">
					<ul>
						...
						<li class="active disabled"><a href="viewBehindScenes.php"><i class="fas fa-theater-masks" style="color: white; font-size: 25px; margin-right: 15px;"></i>Insert BehindScenes</a></li>
		...
		<div class="col-md-9">
			...
			?>
				...
				<a href="insertBehindScenes.php" class="btn btn-info" style="float:right">Insert Scense</a>
