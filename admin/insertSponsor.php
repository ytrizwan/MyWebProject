	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="container" style="background: #FFF;">
				...
				<form action="insertSponsor.php" method="post" enctype="multipart/form-data">
					<label for="nameId">Name of Sponsor</label>
					<input required type="text" name="name" id="nameId" class="form-control"><br>
					
					<label for="imgId">Image of Sponsor</label>
					<input required type="file" name="img" id="imgId" class="form-control"><br>
					
					<label for="msgId">About Sponsor</label>
				...
				<?php
					if(isset($_POST['submit'])){
						...
						$msg = $_POST['msg'];
						$insert = "INSERT INTO sponsor(name, img, msg)
									VALUE('$name', '$img', '$msg')";
						$run = mysqli_query($conn, $insert);
						if($run){
							move_uploaded_file($imgPath, "dynamicImages/sponsors/$img");
