...
<body>
	<div class="row">
			...
			<div class="heading">
				...
				<div class="menu">
					<ul>
						...
						<li class="active disabled"><a href="viewBehindScenses.php"><i class="fas fa-theater-masks" style="color: white; font-size: 25px; margin-right: 15px;"></i>Insert BehindScense</a></li>
		...
		<div class="col-md-9">
			...
			<?php
			$judge_query = "SELECT * FROM behindscense
									ORDER BY id DESC";
			$connect_judge_query = mysqli_query($conn, $judge_query);
			$count_rows = mysqli_num_rows($connect_judge_query);
			$number_of_items = 1;
			?>
				<h2>View Behind Scenses</h2>
				<h6 style="font-weight: bold">Total Behind Scenses : <span class="badge"><?php echo $count_rows; ?></span></h6>
				<hr>
				<center><h3><?php echo $get; ?></h3></center>
				<a href="insertBehindScense.php" class="btn btn-info" style="float:right">Insert Scense</a>
			...
			?>	
						<tr>
							...
							<th>&nbsp;<a href="deleteBehindScense.php?id=<?php echo $id_of_judge; ?>" class="btn btn-danger">Delete</a></th>
						</tr>
			<?php
				}
			}
