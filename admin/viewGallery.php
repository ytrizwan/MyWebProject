...
<body>
	<div class="row">
			...
			<div class="heading">
				...
				<div class="menu">
					<ul>
						...
						<li class="active disabled"><a href="viewGallery.php"><i class="fas fa-images" style="color: white; font-size: 25px; margin-right: 15px;"></i>Insert Gallery</a></li>
		...
		<div class="col-md-9">
			...
			<?php
			$judge_query = "SELECT * FROM gallery
									ORDER BY id DESC";
			...
			?>
				<h2>View Gallery</h2>
				<h6 style="font-weight: bold">Total Gallery : <span class="badge"><?php echo $count_rows; ?></span></h6>
				<hr>
				<center><h3><?php echo $get; ?></h3></center>
				<a href="insertGallery.php" class="btn btn-info" style="float:right">Insert Gallery</a>
			...
			?>	
						<tr>
							...
							<th>&nbsp;<a href="deleteGallery.php?id=<?php echo $id_of_judge; ?>" class="btn btn-danger">Delete</a></th>
						</tr>
			<?php
				}
			}
